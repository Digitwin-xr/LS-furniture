        ...
        <section className="pb-24 w-full block">
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-8 items-center w-full">
            ...
            <div className="flex flex-col items-center w-full lg:w-[65%] order-2 lg:order-2 px-0 lg:px-4">
              <div className="relative w-full h-[80vh] lg:h-auto lg:aspect-[16/9] bg-gradient-to-br from-[#FAFAFA] to-[#F1F1F1] rounded-none lg:rounded-[3rem] border-y lg:border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.06)] overflow-hidden group">
